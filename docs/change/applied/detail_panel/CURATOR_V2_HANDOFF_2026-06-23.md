...
1. **`templates/_datasheet.html`** — Tabulator grid component (child of `_datasheet_with_header.html`)
   - Location: `/mnt/user-data/outputs/_datasheet.html`
   - Copy to: `templates/_datasheet.html`

2. **`templates/_datasheet_with_header.html`** — Datasheet with header bar (+ button, search)
   - Location: `/mnt/user-data/outputs/_datasheet_with_header.html`
   - Copy to: `templates/_datasheet_with_header.html`

3. **`templates/_detail_panel.html`** — Tabbed detail form with child datasheets
   - Location: `/mnt/user-data/outputs/_detail_panel.html`
   - Copy to: `templates/_detail_panel.html`
...
| File | What | Where |
|------|------|-------|
| `_datasheet.html` | Grid only | templates/ |
| `_datasheet_with_header.html` | Grid + controls | templates/ |
| `_detail_panel.html` | Tabs + forms | templates/ |
